...
class FullscreenMenuNavWalker extends \Walker_Nav_Menu {
    ...
    function start_lvl(&$output, $depth=0, $args=null) { 
        ...
        $output .= "<div><p>Fullscreen Nav Walker</p></div><div class='submenu-outer-wrapper depth-" . $depth . "'><div class='submenu-middle-wrapper'><div class='submenu-inner-wrapper'><ul class='submenu-list depth-" . $depth . "'>";
    }
