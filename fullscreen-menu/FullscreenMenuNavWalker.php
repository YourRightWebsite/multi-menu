...
class fullscreenMenuNavWalker extends \Walker_Nav_Menu {
    ...
    function start_el(&$output, $item, $depth=0, $args=null, $id=0) { 
        ...
        if($depth === 0 && $is_first) {
            ...
            $output .= "
                <li class='multi-menu js-multi-menu-fullscreen multi-menu-fullscreen count-items-" . $this->toplevel_total_items . " ". $this->css_classes . " " . $this->params['additional_classes'] ." multi-menu-fullscreen-" . $this->params['id'] . " " . $menu_invert_class . "'>

                    <div class='menu-toggle-container'>
                        <button class='js-multi-menu-fullscreen-toggle-open'>
                            ".$menu_button_open_text."
                    ...
                    <div class='menu-fullscreen-container'>
                        ...
                        <div class='menu-fullscreen-container-close-container'>
                            <button class='js-multi-menu-fullscreen-toggle-close'>
                                ". $menu_button_close_text ."
                                <span class='button-icon'>
                                    <svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' stroke-width='1.5' stroke='currentColor' class='size-6'>
                        ...
                        <ul class='menu-fullscreen-container-inner'>
