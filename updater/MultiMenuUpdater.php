...
/* Self Hosted Github Updates adapted from: https://anchor.host/using-github-to-self-host-updates-for-wordpress-plugins/ */

class MultiMenuUpdater {
    ...
    public function __construct() {
        ...
        if ( defined( 'MULTI_MENU_DEV_MODE' ) ) {
    ...
    public function request(){
        ...
        if( false === $remote || ! $this->cache_allowed ) {
            ...
            $remote = wp_remote_get( 'https://raw.githubusercontent.com/YourRightWebsite/multi-menu/refs/heads/main/plugin-selfupdate.json', [
                    'timeout' => 10,
                    'headers' => [
